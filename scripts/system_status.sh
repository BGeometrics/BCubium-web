...
echo "{\"bitcoin\":\"$BITCOIN_SERVICE\", \"lnd\":\"$LND_SERVICE\", \"electrum\":\"$ELECTRUM_SERVICE\", \"btcrpcexplorer\":\"$BTCRPCEXPLORER_SERVICE\", \"rtl\":\"$RTL_SERVICE\", \"tor\":\"$TOR_SERVICE\", \"firewall\":\"$FIREWALL_SERVICE\", \"openvpn\":\"$OPENVPN_SERVICE\", \"electrum_activated\":\"$ELECTRUM_ACTIVATED\", \"wireguard\":\"$WIREGUARD_SERVICE\"}"
